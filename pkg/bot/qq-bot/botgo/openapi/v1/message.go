...
import (
	...
	"github.com/guojia99/my_cubing_robot/pkg/bot/qq-bot/botgo/errs"
...
func (o *openAPI) PostGroupMessage(ctx context.Context, groupID string, msg *dto.GroupMessageToCreate) (*dto.Message, error) {
	resp, err := o.request(ctx).
		SetResult(dto.Message{}).
...
// RetractMessage 撤回消息
func (o *openAPI) RetractMessage(
	ctx context.Context,
	channelID, msgID string, options ...openapi.RetractMessageOption,
) error {
...
func (o *openAPI) PostSettingGuide(
	ctx context.Context,
	channelID string, atUserIDs []string,
) (*dto.Message, error) {
	var content string
