...
func (o *openAPI) ChannelRolesPermissions(
	ctx context.Context,
	channelID, roleID string,
) (*dto.ChannelRolesPermissions, error) {
	rsp, err := o.request(ctx).
...
func (o *openAPI) PutChannelPermissions(
	ctx context.Context, channelID, userID string,
	p *dto.UpdateChannelPermissions,
) error {
	if p.Add != "" {
...
func (o *openAPI) PutChannelRolesPermissions(
	ctx context.Context, channelID, roleID string,
	p *dto.UpdateChannelPermissions,
) error {
	if p.Add != "" {
		if _, err := strconv.ParseUint(p.Add, 10, 64); err != nil {
