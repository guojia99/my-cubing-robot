...
func (o *openAPI) CreateMessageReaction(
	ctx context.Context,
	channelID, messageID string, emoji dto.Emoji,
) error {
	_, err := o.request(ctx).
...
func (o *openAPI) DeleteOwnMessageReaction(
	ctx context.Context,
	channelID, messageID string, emoji dto.Emoji,
) error {
	_, err := o.request(ctx).
...
func (o *openAPI) GetMessageReactionUsers(
	ctx context.Context, channelID, messageID string, emoji dto.Emoji,
	pager *dto.MessageReactionPager,
) (*dto.MessageReactionUsers, error) {
	if pager == nil {
