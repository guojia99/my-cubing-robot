...
func (o *openAPI) PostDirectMessage(
	ctx context.Context,
	dm *dto.DirectMessage, msg *dto.MessageToCreate,
) (*dto.Message, error) {
	resp, err := o.request(ctx).
...
func (o *openAPI) RetractDMMessage(
	ctx context.Context,
	guildID, msgID string, options ...openapi.RetractMessageOption,
) error {
...
func (o *openAPI) PostDMSettingGuide(
	ctx context.Context,
	dm *dto.DirectMessage, jumpGuildID string,
) (*dto.Message, error) {
