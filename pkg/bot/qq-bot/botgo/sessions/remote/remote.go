...
import (
	...
	"github.com/guojia99/my_cubing_robot/pkg/bot/qq-bot/botgo/sessions/manager"
	"github.com/guojia99/my_cubing_robot/pkg/bot/qq-bot/botgo/sessions/remote/lock"
...
func (r *RedisManager) Start(apInfo *dto.WebsocketAP, token *token.Token, intents *dto.Intent) error {
	...
	log.Infof(
		"[ws/session/redis] will start %d sessions and per session start interval is %s",
